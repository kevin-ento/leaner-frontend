...
const CourseFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(error.response?.data?.message || `Failed to ${isEditing ? "update" : "create"} course`, "error")
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto py-8 px-4">
        ...
        <div className="card p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{isEditing ? "Edit Course" : "Create New Course"}</h2>
