...
const SessionFormPage = () => {
    ...
    try {
      ...
      if (sessionData) {
        setFormData({
          ...
          date: sessionData.date ? new Date(sessionData.date).toISOString().slice(0, 16) : "",
          courseId: sessionData.courseId?._id || sessionData.courseId?.id || sessionData.courseId || "",
        })
      }
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(error.response?.data?.message || `Failed to ${isEditing ? "update" : "create"} session`, "error")
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto py-8 px-4">
        ...
        <div className="card p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{isEditing ? "Edit Session" : "Add New Session"}</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <select
                ...
                className={`input-field ${errors.courseId ? "border-red-500 focus:ring-red-500" : ""}`}
              ...
              {courses.length === 0 && (
                <p className="mt-1 text-sm text-gray-500">No courses available. Please create a course first.</p>
              )}
            </div>
            ...
            <div className="flex space-x-4">
              <Button type="submit" loading={loading} disabled={courses.length === 0}>
